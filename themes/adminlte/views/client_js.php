                    ...
                    <div class="row">
                         <form class="col s12" id="client_form">
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-6 input-field">
                                    <div class="form-group">
									 <?php echo lang('last_client_name', 'name1'); ?><font color="#FF0017"> *</font>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fas  fa-user"></i>
                                            </div>
                           ...
                           <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-6 input-field">
                                    <div class="form-group">
                                        <?php echo lang('client_telephone', 'telephone1'); ?>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fas  fa-phone"></i>
                                            </div>
                                            <input type="text" name="telephone" id="telephone1" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-6 input-field">
